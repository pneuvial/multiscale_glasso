...
<!-- chosen by stability selection. The hyperparameter of the StARS approach is
set to $0.05$ which might select the Lasso penalty that leads to a sparse and
stable graph between subsampled graphs. The grid of values taken by the fusion
parameter $\lambda_2$ is set to $[0, 20].$  -->
