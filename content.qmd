...
```{r roc_erdos , message=FALSE, fig.cap=fig.4_cap, echo = TRUE}
...
```{r roc_scale_free , message=FALSE, fig.cap=fig.5_cap, echo = TRUE}
...
```{r roc_sbm , message=FALSE, fig.cap=fig.6_cap, echo = TRUE}
...
```{r, echo=FALSE,out.width="49%", out.height="20%",fig.cap=fig.10_cap,fig.show='hold',fig.align='center', echo = TRUE}
