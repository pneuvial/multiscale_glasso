...
remove.packages("mglasso")
.rs.restartR()
install.packages("/Users/doedmond.sanou/phd/mglasso_0.1.3.tar.gz", repos = NULL, type = 'source')

library(mglasso)

path_functions <- "./simulation-experiments/functions/"
