...
fused-Lasso type penalty for clustering. </edmond>

In the spirit of convex clustering, introduced by
@pelckmans2005convex, @Hocking2011, @Lindsten2011, the clustering path is obtained by spanning the
entire regularization path. <old> At each level of the hierarchy, variables in
