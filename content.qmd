...
$\boldsymbol A_{ij}$ is a $(p-1)\times p(p-1)$ matrix <old> defined by
...
Infered graphs using MGLasso for different values of total variation
penalty.
:::
...
deduced partition is composed of $80$ clusters. A confusion matrix
